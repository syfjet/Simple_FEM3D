...
Несмотря на простоту реализации программа позволяет расчитывать конструкции с точечным и распределённым нагружением, в которых может присутствовать несколько материалов с разнличными упругими свойствами.
